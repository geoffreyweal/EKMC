...
def get_MLJ_parameters(molecule1, molecule2, displacement_vector, coupling_energy, huang_rhys_factor, uu_max, vv_max, WW, classical_reorganisation_energy, temperature):
