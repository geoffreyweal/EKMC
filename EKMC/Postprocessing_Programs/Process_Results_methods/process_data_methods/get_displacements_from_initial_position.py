...
def get_displacements_from_initial_position(displacement_vectors_from_initial_position, cpu_count=1):
    ...
    displacements_from_initial_position = process_map(get_displacements_from_initial_position_for_simulation, displacement_vectors_from_initial_position, max_workers=cpu_count, unit=' KMC Sim')
