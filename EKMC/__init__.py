...
if not packaging_found:
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The EKMC program requires the "packaging" program.'+'\n'
	toString += '\n'
	toString += 'Install packaging through pip by following the instruction in https://github.com/GardenGroupUO/EKMC'+'\n'
...
if not networkx_found:
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The EKMC program requires the "networkx" program.'+'\n'
	toString += '\n'
	toString += 'Install networkx through pip by following the instruction in https://github.com/GardenGroupUO/EKMC'+'\n'
...
if not tqdm_found:
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The EKMC program requires the "tqdm" program..'+'\n'
	toString += '\n'
	toString += 'Install tqdm through pip by following the instruction in https://github.com/GardenGroupUO/EKMC'+'\n'
...
if not tqdm_found:
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The EKMC program requires the "xlsxwriter" program..'+'\n'
	toString += '\n'
	toString += 'Install xlsxwriter through pip by following the instruction in https://github.com/GardenGroupUO/EKMC'+'\n'
