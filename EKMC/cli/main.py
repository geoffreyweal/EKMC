...
commands = [
    ('mass_submit',     'EKMC.EKMC_Programs.Run_ekmc_mass_submitSL_slurm'),
    ('did_complete',    'EKMC.EKMC_Programs.EKMC_Did_Complete'),
    ('process_results', 'EKMC.Postprocessing_Programs.Process_Results'),
]

def main(prog='Exciton Kinetic Monte Carlo', description='EKMC command line tool.',version=__version__, commands=commands, hook=None, args=None):
