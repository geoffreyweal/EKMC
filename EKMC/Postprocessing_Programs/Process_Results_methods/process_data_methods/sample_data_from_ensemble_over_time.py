...
def sample_data_from_ensemble_over_time(all_sims, sim_time_limit, no_of_times_to_sample=10000, cpu_count=1):
    ...
    data_over_time_for_all_sims = process_map(get_data_over_time, get_inputs(all_sims, sim_time_limit, no_of_times_to_sample), max_workers=cpu_count, unit=' KMC Sim', total=len(all_sims))
...
def get_data_over_time(input_datum):
    ...
    for time in times:
        ...
        count, molecule, cell_point, sim_time, change_in_time, energy, sum_of_kij = simulation_datum[1][index]
