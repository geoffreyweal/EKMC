...
class GraphMatcher:
    ...
    def get_all_unique_isomorphic_graphs(self):
        ...
        This method has been created by Geoff and is a modified version of the is_isomorphic method from the original networkx code.
        """
        ...
        # obtain all the isomorphic index graph representations between the two graphs
        all_ico_counter = 0
        all_unique_icos = []
