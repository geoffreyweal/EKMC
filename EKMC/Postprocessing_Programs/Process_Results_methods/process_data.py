...
def process_data(all_sims, centre_of_masses, unit_cell_matrix, sim_time_limit, no_of_times_to_sample=10000, cpu_count=1):
    """
    ...
    print('Sample '+str(no_of_times_to_sample)+' data points from the ensemble of simulations')
    data_over_time_for_all_sims, times = sample_data_from_ensemble_over_time(all_sims, sim_time_limit, no_of_times_to_sample=no_of_times_to_sample, cpu_count=cpu_count)
    ...
    # Fourth, get the diffusion values of the system over time.
    ...
    # Fifth, get the diffusion tensor of the system over time.
    ...
    # Sixth, get data for plotting and showing/comparing
    ...
    # Seventh, gather the timestep information from across all ensembles
