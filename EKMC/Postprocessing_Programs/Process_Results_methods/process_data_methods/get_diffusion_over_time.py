...
def get_diffusion_over_time(times, displacement_squared_values_from_initial_position, cpu_count=1):
    ...
    diffusion_over_time = process_map(get_diffusion_at_time, get_inputs(times, displacement_squared_values_from_initial_position), max_workers=cpu_count, unit=' sample times', total=len(times))
...
def convert_diffusion_coefficient(diffusion_coefficient_in_A2_per_ps):
    ...
    diffusion_coefficient_in_cm2_per_s = diffusion_coefficient_in_A2_per_ps * (A_to_cm ** 2.0) / ps_to_s
